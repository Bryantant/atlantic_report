...
def get_by_month_transactions(supplier, filters):
    ...
    opening_sql = """
        SELECT account_currency, SUM(credit_in_account_currency - debit_in_account_currency) AS opening_bal
        FROM `tabGL Entry`
    ...
    opening_by_ccy = {r.account_currency: flt(r.opening_bal, 2) for r in opening_results}
