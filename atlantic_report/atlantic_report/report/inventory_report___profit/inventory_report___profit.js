...
frappe.query_reports["Inventory Report - Profit"] = {
    onload(report) {
    ...
    "formatter": function (value, row, column, data, default_formatter) {
        ...
        // 1. Definisikan Style Dasar [REVISI] Font 12px
        let style = "font-size: 12px; vertical-align: top; white-space: nowrap;";

        // 2. Logika Rata Kanan untuk Kolom Angka
        const right_align_cols = [
            "qty_info", 
            "sales_ret_amt", 
            "cost_info", 
            "profit_info", 
        ...
        if (right_align_cols.includes(column.fieldname)) {
            style += " text-align: right; display: block; width: 100%;";
        }

        // 3. Logika Bold untuk Row Total [REVISI] Tanpa Background Color
